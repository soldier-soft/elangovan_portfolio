  ...
  const experiences = [
    {
      ...
      company: "INFOLABS (ZHAGARAM)",
      period: "2024/07 – 2024/08",
      location: "Arcot, Tamil Nadu",
      points: [
        "Built responsive web features using HTML, CSS, JavaScript, and React.js.",
        "Created automated test suites to validate performance and reliability.",
        "Deployed applications on GCP and GoDaddy with focus on secure access control and compliance.",
        "Practiced Agile sprint methodologies and version control using Git.",
      ],
    },
  ];
