        ...
        <div ref={ref} className="relative border-l border-gray-700 pl-6 space-y-10">
          ...
          >
            ...
            <div className="bg-gray-900/50 backdrop-blur-lg p-6 rounded-2xl border border-gray-800 
              ...
              <p className="text-purple-400 text-sm mb-1">SRI BALAJI CHOCKALINGAM ENGINEERING COLLEGE</p>
          ...
          >
            ...
            <div className="bg-gray-900/50 backdrop-blur-lg p-6 rounded-2xl border border-gray-800 
              ...
              <h3 className="text-lg font-semibold">Higher Secondary (HSC)</h3>
              <p className="text-purple-400 text-sm">SRI VIJAY MATRIC HIGHER SECONDARY SCHOOL</p>
              <p className="text-gray-400 text-sm mb-2">VANAKULAM, TAMIL NADU, INDIA | 2021</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="bg-gray-900/50 backdrop-blur-lg p-6 rounded-2xl border border-gray-800 
              ...
              <h3 className="text-lg font-semibold">Secondary School (SSLC)</h3>
              <p className="text-purple-400 text-sm">DON BOSCO HIGHER SECONDARY SCHOOL</p>
              <p className="text-gray-400 text-sm mb-2">POLUR, TAMIL NADU, INDIA | 2019</p>
            </div>
          </motion.div>
