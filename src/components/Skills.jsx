  ...
  const skillCategories = [
    {
      ...
      title: "Backend",
      skills: ["Java SE", "Python", "Node.js", "REST APIs", "Flask"],
    },
    {
    ...
    },
    {
      ...
      skills: ["MySQL", "NoSQL", "GCP", "AWS", "GoDaddy"],
    },
    {
      icon: <Terminal className="w-6 h-6 text-yellow-500" />,
      title: "Tools & Methods",
      skills: ["Git", "VS Code", "Postman", "SDLC", "Agile"],
    },
    {
      icon: <Brain className="w-6 h-6 text-pink-500" />,
      title: "Specializations",
      skills: ["Data Science", "Data Analysis", "Machine Learning", "IoT", "OOPS"],
    },
  ];
